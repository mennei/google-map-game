...
/* harmony import */ var _src_fe_MapContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/fe/MapContainer */ "./src/fe/MapContainer.js");



const Index = () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_src_fe_MapContainer__WEBPACK_IMPORTED_MODULE_1__["default"], null);
...
class MapContainer extends react__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(...args) {
    super(...args);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(this, "onMarkerDragEnd", coord => {
      const {
        latLng
      } = coord;
      ...
      this.setState({
        ...
        return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()(`http://localhost:3000/api/v1/googleMap/getDistance?ballLocation=${ballLocation}&goalLocation=${goalLocation}`).then(resopnse => resopnse.json()).then(data => {
          console.log(data);
          this.setState({
            ballLocation: {
              lat: lat,
  ...
  componentDidUpdate() {
    ...
    if (loading) {
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()(url).then(resopnse => resopnse.json()).then(data => {
        this.setState({
          goalLocation: {
            lat: data.data.lat,
            lng: data.data.lng
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(google_maps_react__WEBPACK_IMPORTED_MODULE_4__["Map"], {
      google: google,
      zoom: 20,
      style: mapStyles,
      initialCenter: ballLocation
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(google_maps_react__WEBPACK_IMPORTED_MODULE_4__["Marker"], {
      name: 'Ball position',
...
module.exports = __webpack_require__(/*! C:\Users\user\projects\ludus\menachem-app\pages\index.js */"./pages/index.js");
